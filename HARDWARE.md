...
## Hardware choices <a name="hardware-choices"/>

### **E-ink display**: Waveshare 1.54-inch E-Ink E-Paper Display Panel - Black and White <a name="e-ink"/>

The measured parameter values (T, P, H, CO2ppm) need to be constantly displayed 
and they should be updated every ~1-5min.
...
### **ESP-32 microcontroller**: Waveshare Universal e-Paper Raw Panel Driver Board - ESP32 <a name="esp32"/>

ESP32 microcontrollers can be as cheap as an Arduino Nano but supports Wifi and Bluetooth connection.
...
### **Sensor for temperature, pressure, and humidity**: BME280 <a name="bme280"/>
...
### **Sensor for CO2 concentration**: GY-SCD40 <a name="co2sensor"/>
...
| CO2ppm sensor | 18.25 |
| **Total** | **44.25** |
| **Total (without CO2 sensor)** | **26.00** |

This price does not include the tools nor cheap materials:
- a solvering iron
- soldering tin
- a 3D printer
- 3D printer plastic
